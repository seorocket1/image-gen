/*
  # Fix Admin System and User Management
  ...
  4. Security
    ...
    - Add policies for authenticated users to read/update admin settings
...
-- Drop other functions before recreating them
...
-- Recreate the handle_new_user function to handle missing metadata gracefully
